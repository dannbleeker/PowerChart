...
**Six of the eight closed on 2026-08-29; 11 and 12 closed on 2026-08-31. Five
are open now — four the owner's, one engineering:**
...
Items 3, 11 and 5 are the owner's: two are decisions about what a user RECEIVES
— one about how a crowded slide is drawn, one about how a pasted NUMBER is read
— and one goes out under his GitHub identity. Item 12 is engineering and is the
sharpest open defect: a Stop the user pressed is cleared by the next click and
the cancelled work lands. Items 9 and 10 were both closed on 2026-08-31 — the
violin costed and thinned, the 1.10 question decided WARN AND PICTURE.
