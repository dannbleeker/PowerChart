...
closed on 2026-09-01. Seven are open now — four the owner's, three
engineering:**
   ...
   16  fixture refresh — 3 of 4 checks confirmed by rounds 347-349; only the
       rotation probe still needs a round where a pass reads
