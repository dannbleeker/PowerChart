...
**Six of the eight closed on 2026-08-29; 11 and 12 closed on 2026-08-31. Eight
are open now — four the owner's, four engineering:**
   ...
   15  seven scenarios have never failed; the stop scenario passes on a
       path it does not claim (engineering)
   16  what the next round has to confirm, and the 53-round-stale fixture
       refresh waiting behind it (engineering)
   17  the deck scan's paging loop has never run a second iteration on a
       real host — deepest deck ever scanned is 9 slides (engineering)
   18  no ratchet varies `decorations`, so the text-overlap budget is
       measured with the text mostly off (engineering)
