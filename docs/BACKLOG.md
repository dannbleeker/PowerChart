...
**Six of the eight closed on 2026-08-29. Three are open now — two the owner's, one
engineering:**
...
Items 3 and 5 are the owner's: one is a product decision about what a user
RECEIVES, one goes out under his GitHub identity. Item 9 is engineering and is a
measurement waiting to be costed rather than a defect. Item 10 was the third and
is closed — decided WARN AND PICTURE and shipped the same day.
