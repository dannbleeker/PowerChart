...
/**
 * Combo charts — mixed column/line/area/waterfall/mekko bases, secondary axes,
 * small multiples, and the off-chain / overflow guards. Consolidated from the
 * per-increment suites (combo-multiples-fixes, bughunt3-combo).
 */
