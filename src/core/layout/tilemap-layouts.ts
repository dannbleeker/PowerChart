...
export const US_TILES: TileLayout = {
  ...
  WA: [1, 2], MT: [2, 2], ND: [3, 2], SD: [4, 2], MN: [5, 2], WI: [6, 2], MI: [7, 2], NY: [9, 2], CT: [10, 2], RI: [11, 2],
  OR: [1, 3], ID: [2, 3], WY: [3, 3], NE: [4, 3], IA: [5, 3], IL: [6, 3], IN: [7, 3], OH: [8, 3], PA: [9, 3], NJ: [10, 3],
  CA: [0, 4], NV: [1, 4], UT: [2, 4], CO: [3, 4], KS: [4, 4], MO: [5, 4], KY: [6, 4], WV: [7, 4], DC: [8, 4], MD: [9, 4], DE: [10, 4],
...
export const EUROPE_TILES: TileLayout = {
  IS: [0, 0], NO: [4, 0], SE: [5, 0], FI: [6, 0],
  EE: [7, 1],
  IE: [0, 2], GB: [1, 2], NL: [3, 2], DK: [4, 2], LV: [7, 2],
  BE: [3, 3], DE: [4, 3], CZ: [5, 3], PL: [6, 3], LT: [7, 3], BY: [8, 3], RU: [9, 3],
  FR: [2, 4], LU: [3, 4], AT: [4, 4], SK: [5, 4], RS: [6, 4], RO: [7, 4], UA: [8, 4],
  PT: [0, 5], ES: [1, 5], CH: [3, 5], SI: [4, 5], HU: [5, 5], BA: [6, 5], BG: [7, 5], MD: [8, 5],
  IT: [3, 6], HR: [5, 6], ME: [6, 6], MK: [7, 6], TR: [8, 6],
  MT: [2, 7], AL: [6, 7], GR: [7, 7], CY: [9, 7],
};
...
export const WORLD_TILES: TileLayout = {
  NA: [1, 0], EU: [3, 0], CIS: [5, 0],
  MEA: [3, 1], SA: [4, 1], EA: [5, 1],
  LATAM: [1, 2], SSA: [3, 2], SEA: [5, 2],
  OCE: [5, 3],
};
